 ...
 */
final class Version20220215174850 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE cours ADD salleassocie_id INT NOT NULL');
