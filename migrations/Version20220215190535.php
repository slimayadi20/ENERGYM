 ...
 */
final class Version20220215190535 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE article ADD comments VARCHAR(255) NOT NULL');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE article DROP comments, CHANGE titre titre VARCHAR(40) NOT NULL COLLATE `utf8mb4_unicode_ci`, CHANGE date_creation date_creation VARCHAR(35) NOT NULL COLLATE `utf8mb4_unicode_ci`, CHANGE description description VARCHAR(255) NOT NULL COLLATE `utf8mb4_unicode_ci`');
