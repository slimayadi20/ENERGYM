 ...
 */
final class Version20220215193927 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE evenement CHANGE description_event description_event VARCHAR(1000) NOT NULL, CHANGE lieu_event lieu_event VARCHAR(1000) NOT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE evenement CHANGE description_event description_event VARCHAR(255) NOT NULL, CHANGE lieu_event lieu_event VARCHAR(255) NOT NULL');
