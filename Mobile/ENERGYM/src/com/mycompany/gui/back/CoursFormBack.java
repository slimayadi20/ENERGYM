 ...
 * @author MSI
 */
public class CoursFormBack extends BaseFormBack {

    private static String titre = "";
    private static String contenu = "";
    private static float id ;

    public CoursFormBack(Resources res ) {
 ...
 Form previous = Display.getInstance().getCurrent();
        ...
        RadioButton all = RadioButton.createToggle("Mes Cours", barGroup);
        ...
        ArrayList<Cours> en = ServiceCours.getInstance().getAllCoursBack();
        ...
        Display.getInstance().scheduleBackgroundTask(() -> {
            ...
            Display.getInstance().callSerially(() -> {
                for (Cours eyy : en) {
                    ...
                    addButton(res.getImage("news-item-1.jpg"), eyy.getNom(), res,eyy.getDescription(),eyy.getId(),eyy.getNomCoach(),eyy.getNombre(),eyy.getJour());
  ...
  fab.addActionListener(e -> {
    ...
    private void addButton(Image img, String nom,Resources res,String description,float id,String nomcoach,String nombre,String jour) {
        ...
        TextArea address = new TextArea(description);
        address.setUIID("NewsTopLine");
        address.setEditable(false);
     
         TextArea Jour = new TextArea(jour);
...
new UpdateCoursFormBack(res,id,nom,description,nomcoach,nombre,jour).show();
