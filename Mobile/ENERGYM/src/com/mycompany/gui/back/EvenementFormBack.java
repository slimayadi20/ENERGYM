 ...
 * @author MSI
 */
public class EvenementFormBack extends BaseFormBack {

    private static String titre = "";
    private static String contenu = "";
    private static float id;

    public EvenementFormBack(Resources res) {
        ...
        ArrayList<Evenement> en = ServiceEvenement.getInstance().getAllEvenementsBack();
        ...
        fab.addActionListener(e -> {
              new AddEvenementFormBack(res).show();
        });
...
//    public UpdateEvenementBack(Resources res, String nomEvente, String DescriptionEvente, String LieuEvente,String NbrParticipantsEvente,String DateEvente,Float id) {
                ...
                UpdateEvenementBack a = new UpdateEvenementBack(res,nomevent,desc,lieu, nbr.toString(),date,id);
            //   System.out.println(id);
               a.show();
        });
    }
