 ...
 * @author MSI
 */
public class SalleFormBack extends BaseFormBack {

    private static String titre = "";
    private static String contenu = "";
    private static float id;

    public SalleFormBack(Resources res) {
        super("Sallen", BoxLayout.y());
        ...
        RadioButton all = RadioButton.createToggle("Mes Salle", barGroup);
        ...
        ArrayList<Salle> en = ServiceSalle.getInstance().getAllSalle();
        ...
        Display.getInstance().scheduleBackgroundTask(() -> {
            ...
            Display.getInstance().callSerially(() -> {
                for (Salle eyy : en) {
                    ...
                    addButton(res.getImage("news-item-1.jpg"), eyy.getNom(), res, eyy.getAdresse(),eyy.getId(),eyy.getTel(),eyy.getMail(), eyy.getDescription());
   ...
   Container round = new Container();
    ...
    private void addButton(Image img, String Nom, Resources res, String Adresse, float id, String Tel,String Mail,String Description) {
        ...
        TextArea address = new TextArea(contenu);
        ...
        image.addActionListener(e -> {
            ...
            UpdateSalleFormBack a = new UpdateSalleFormBack(res,id, Nom, Adresse, Tel, Mail, Description);
