 ...
 * @author MSI
 */
public class CategorieEventFormBack extends BaseFormBack {

    private static String titre = "";
    private static String contenu = "";
    private static float id;

    public CategorieEventFormBack(Resources res) {
        super("CategorieEventFormBack", BoxLayout.y());

        Toolbar tb = new Toolbar(true);
        setToolbar(tb);
        getTitleArea().setUIID("Container");
        setTitle("Les CategorieEvents");
        ...
        RadioButton all = RadioButton.createToggle("Mes CategorieEvents", barGroup);
        ...
        ArrayList<CategorieEvent> en = ServiceCategorieEvent.getInstance().getAllCategorieEvents();

        Display.getInstance().scheduleBackgroundTask(() -> {

            Display.getInstance().callSerially(() -> {
                for (CategorieEvent eyy : en) {
                    addButton(res.getImage("news-item-1.jpg"), eyy.getNomCategorie(), res, eyy.getId());
                }
            });
        });
        ...
        fab.addActionListener(e -> {
              new AddCategorieEventFormBack(res).show();
        });
...
//    public UpdateCategorieEventBack(Resources res, String nomEvente, String DescriptionEvente, String LieuEvente,String NbrParticipantsEvente,String DateEvente,Float id) {
                ...
                UpdateCategorieEventBack a = new UpdateCategorieEventBack(res,id,nomevent);
            //   System.out.println(id);
               a.show();
        });
    }
