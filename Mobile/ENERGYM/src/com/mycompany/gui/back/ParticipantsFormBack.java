 ...
 * @author MSI
 */
public class ParticipantsFormBack extends BaseFormBack {

    private static String titre = "";
    private static String contenu = "";
    private static float id;

    public ParticipantsFormBack(Resources res) {
        super("Events", BoxLayout.y());

        Toolbar tb = new Toolbar(true);
        setToolbar(tb);
        getTitleArea().setUIID("Container");
        setTitle("Les Participantss");
        ...
        RadioButton all = RadioButton.createToggle("Mes Participantss", barGroup);
        ...
        ArrayList<Participants> en = ServiceParticipation.getInstance().getAllParticipantsBack();

        Display.getInstance().scheduleBackgroundTask(() -> {

            Display.getInstance().callSerially(() -> {
                for (Participants eyy : en) {
String id = Float.toString(eyy.getId());
String idevent = Float.toString(eyy.getIdevent());
String iduser = Float.toString(eyy.getIduser());
                    addButton(res.getImage("news-item-1.jpg"),id,res,idevent,iduser);
                }
            });
        });
    ...
    private void addButton(Image img, String nomevent, Resources res, String date, String id) {
