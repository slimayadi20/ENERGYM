 ...
 * @author Chédy
 */
public class StatFormBack extends BaseForm {
    ...
    public StatFormBack(Resources res) {
    ...
    /* public StatistiquePieForm(SideMenu aThis, Resources res) {
    ...
    private void addButton(Image img, String title) {
        ...
        image.addActionListener(e -> {
            try {
                //new CommentaireForm(Resources.getGlobalResources()).show();
            } catch (Exception exx) {
    ...
    public void createPieChartForm() {
        ...
        String[] messages = {
            "Statistique par quantite de produit"
        };
    ...
    private CategorySeries buildDataset(String title, double prcntFeed, double prcntRec) {
        ...
        ArrayList<CategorieProduit> them;
       ArrayList<Produit> disc;
        //them = new ServiceThematique().getAllThematiques();

            disc = new ServiceProduit().getAllProduit();
        for (Produit thematique : disc) {
           

            series.add(thematique.getNom(), thematique.getQuantite());
        }
