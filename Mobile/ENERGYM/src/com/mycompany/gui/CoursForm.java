...
public class CoursForm extends BaseForm {
    ...
    public CoursForm(Resources res,float id ) {
 ...
 Form previous = Display.getInstance().getCurrent();
        ...
        ArrayList<Cours> en = ServiceCours.getInstance().getAllCours(id);
        ...
        Display.getInstance().scheduleBackgroundTask(() -> {
            ...
            Display.getInstance().callSerially(() -> {
                for (Cours eyy : en) {
                    ...
                    addButton(res.getImage("news-item-1.jpg"), eyy.getNom(), res,eyy.getDescription(),eyy.getId(),eyy.getHeureD(),eyy.getHeureF(),eyy.getJour());
    ...
    private void addButton(Image img, String title,Resources res,String contenu,float id,String dated,String datef,String jour) {
        ...
        address.setEditable(false);
         TextArea dateD = new TextArea(dated);
        dateD.setUIID("NewsTopLine");
        dateD.setEditable(false);
         TextArea dateF = new TextArea(datef);
        ...
        cnt.add(BorderLayout.CENTER,
                BoxLayout.encloseY(
                        ta,address,dateD,dateF,Jour
                ));
        add(cnt);
        image.addActionListener(e -> {
//new CoursForm(res).show();
